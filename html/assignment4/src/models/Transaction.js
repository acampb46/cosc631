...
module.exports = {
    ...
    completeTransaction: async (transactionId) => {
        try {
            ...
            const [commissionResult] = await db.execute('INSERT INTO commissions (purchase_id, commission_amount) VALUES (?,?)', [transaction.payment_intent_id, transaction.commission]);
